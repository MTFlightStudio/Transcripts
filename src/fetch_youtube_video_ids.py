...
published_after = "2020-10-25T00:00:00Z"  # Replace with your start date
published_before =  "2021-01-01T00:00:00Z"# datetime.utcnow().isoformat("T") + "Z"  # Use today's date as the end date
